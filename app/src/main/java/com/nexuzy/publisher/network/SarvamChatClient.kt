 ...
 *   - SarvamApiClient  → grammar correction for articles (uses user's key from Settings)
 *   - SarvamChatClient → David AI in-app chat (uses developer pre-embedded key below)
 */
object SarvamChatClient {

    // Developer-embedded key — NOT taken from user Settings.
    // Replace with your real key from https://dashboard.sarvam.ai
